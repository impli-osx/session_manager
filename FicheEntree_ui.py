...
class Ui_Ficheentree(object):
    def setupUi(self, Ficheentree):
        ...
        self.formLayoutWidget_2.setGeometry(QRect(510, 730, 501, 31))
        ...
        self.label_informations.setGeometry(QRect(200, 30, 281, 51))
        ...
        self.label_reglement.setGeometry(QRect(910, 40, 521, 41))
