...
class Ui_Ficheentree(object):
    def setupUi(self, Ficheentree):
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(460, 730, 615, 31))
        ...
        self.label_informations.setGeometry(QtCore.QRect(140, 30, 281, 51))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        self.label_informations.setFont(font)
        self.label_informations.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_informations.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.NoTextInteraction)
        ...
        self.label_reglement.setGeometry(QtCore.QRect(860, 40, 521, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.label_reglement.setFont(font)
        self.label_reglement.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
