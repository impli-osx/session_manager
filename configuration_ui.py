...
class Ui_Configuration(object):
    def setupUi(self, Configuration):
        ...
        self.activation = QCheckBox(self.accueil)
        self.activation.setObjectName(u"activation")
        self.activation.setGeometry(QRect(20, 60, 361, 31))
        ...
        self.comboBox = QComboBox(self.accueil)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(170, 20, 141, 22))
        ...
        self.retour_gpupdate.setGeometry(QRect(40, 180, 781, 16))
        self.onglet.addTab(self.accueil, "")
        self.formulaire = QWidget()
        self.formulaire.setObjectName(u"formulaire")
        self.activation_fiche = QCheckBox(self.formulaire)
        self.activation_fiche.setObjectName(u"activation_fiche")
        self.activation_fiche.setGeometry(QRect(20, 20, 491, 20))
        self.log_fiche = QCheckBox(self.formulaire)
        self.log_fiche.setObjectName(u"log_fiche")
        self.log_fiche.setGeometry(QRect(20, 60, 491, 20))
        ...
        self.label_14.setGeometry(QRect(20, 140, 391, 16))
        self.timer_dernier_popup = QLineEdit(self.temps)
        self.timer_dernier_popup.setObjectName(u"timer_dernier_popup")
        self.timer_dernier_popup.setGeometry(QRect(410, 140, 51, 21))
        self.label_15 = QLabel(self.temps)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(470, 140, 49, 16))
    ...
    def retranslateUi(self, Configuration):
        ...
        self.activation.setText(QCoreApplication.translate("Configuration", u"Activer Session Manager sur l'ordinateur pour l'utilisateur vis\u00e9.", None))
        ...
        self.activation_fiche.setText(QCoreApplication.translate("Configuration", u"Activer la fiche d'entr\u00e9e demandant les informations personnelles", None))
        self.log_fiche.setText(QCoreApplication.translate("Configuration", u"Stocker les informations donn\u00e9es dans la fiche d'entr\u00e9e dans un document excel", None))
