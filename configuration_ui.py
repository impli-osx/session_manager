...
class Ui_Configuration(object):
    def setupUi(self, Configuration):
        ...
        self.label_titre_2.setGeometry(QRect(20, 100, 151, 16))
        self.label_titre__3 = QLabel(self.titres)
        self.label_titre__3.setObjectName(u"label_titre__3")
        self.label_titre__3.setGeometry(QRect(20, 140, 161, 16))
        self.titre_popup_1 = QLineEdit(self.titres)
        self.titre_popup_1.setObjectName(u"titre_popup_1")
        self.titre_popup_1.setGeometry(QRect(200, 60, 431, 21))
        self.titre_popup_2 = QLineEdit(self.titres)
        self.titre_popup_2.setObjectName(u"titre_popup_2")
        self.titre_popup_2.setGeometry(QRect(200, 100, 431, 21))
        self.titre_popup_3 = QLineEdit(self.titres)
        self.titre_popup_3.setObjectName(u"titre_popup_3")
        self.titre_popup_3.setGeometry(QRect(200, 140, 431, 21))
        self.label_18 = QLabel(self.titres)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setGeometry(QRect(20, 180, 181, 16))
        self.titre_fermeture = QLineEdit(self.titres)
        self.titre_fermeture.setObjectName(u"titre_fermeture")
        self.titre_fermeture.setGeometry(QRect(200, 180, 431, 21))
        ...
        self.titre_reglement.setGeometry(QRect(200, 20, 431, 21))
    ...
    def retranslateUi(self, Configuration):
        ...
        self.label_titre_1.setText(QCoreApplication.translate("Configuration", u"Titre de la premi\u00e8re fen\u00eatre :", None))
        self.label_titre_2.setText(QCoreApplication.translate("Configuration", u"Titre de la seconde fen\u00eatre :", None))
        self.label_titre__3.setText(QCoreApplication.translate("Configuration", u"Titre de la troisi\u00e8me fen\u00eatre :", None))
        self.label_18.setText(QCoreApplication.translate("Configuration", u"Titre de la fen\u00eatre de fermeture :", None))
        ...
        self.label.setText(QCoreApplication.translate("Configuration", u"Largeur des fen\u00eatres :", None))
        self.label_2.setText(QCoreApplication.translate("Configuration", u"pixels", None))
        self.label_3.setText(QCoreApplication.translate("Configuration", u"Hauteur des fen\u00eatres :", None))
        ...
        self.label_19.setText(QCoreApplication.translate("Configuration", u"D\u00e9lai entre l'affichage de la derni\u00e8re fen\u00eatre et de la fermeture de la session : ", None))
