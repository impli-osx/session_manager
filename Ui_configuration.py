...
class Ui_Configuration(object):
    def setupUi(self, Configuration):
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(370, 40, 381, 271))
        ...
        self.mod_bouton_survol.setGeometry(QtCore.QRect(270, 190, 75, 24))
