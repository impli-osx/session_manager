...
class Ui_Configuration(object):
    def setupUi(self, Configuration):
        ...
        self.titre_reglement.setGeometry(QtCore.QRect(200, 20, 431, 21))
    ...
    def retranslateUi(self, Configuration):
        ...
        self.label_titre_1.setText(_translate("Configuration", "Titre de la première fenêtre :"))
        self.label_titre_2.setText(_translate("Configuration", "Titre de la seconde fenêtre :"))
        self.label_titre__3.setText(_translate("Configuration", "Titre de la troisième fenêtre :"))
        self.label_18.setText(_translate("Configuration", "Titre de la fenêtre de fermeture :"))
        ...
        self.label_popup_3.setText(_translate("Configuration", "Texte affiché dans la troisième fenêtre :"))
        self.onglet_popup.setTabText(self.onglet_popup.indexOf(self.onglet_popup_3), _translate("Configuration", "Troisième fenêtre"))
        ...
        self.label.setText(_translate("Configuration", "Largeur des fenêtres :"))
        self.label_2.setText(_translate("Configuration", "pixels"))
        self.label_3.setText(_translate("Configuration", "Hauteur des fenêtres :"))
        ...
        self.label_19.setText(_translate("Configuration", "Délai entre l\'affichage de la dernière fenêtre et de la fermeture de la session : "))
