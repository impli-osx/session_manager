...
class Ui_Configuration(object):
    def setupUi(self, Configuration):
        ...
        self.retour_gpupdate.setGeometry(QtCore.QRect(40, 220, 771, 121))
    ...
    def retranslateUi(self, Configuration):
        ...
        self.Informations.setTitle(_translate("Configuration", "Gestion des champs de la fiche"))
        ...
        self.fiche_reglement.setText(_translate("Configuration", "Afficher le bouton vers le règlement intérieur"))
        self.fiche_afficher.setText(_translate("Configuration", "Afficher la fenêtre du règlement"))
